 ...
 * atrapada o manejada por un bloque try-catch, sino que se debe permitir que sea propagada a través del flujo de datos
 * para que pueda ser capturada por algún operador catch que se encuentre en el camino
 */
...
fun ejem04() {
    ...
    /*
     ...
     si observas la declaración de la interfaz ProducerScope te darás cuenta de que implementa la interfaz SendChanne.
